...
public class DepositEndpoint {
    ...
    public Mono<ResponseEntity<Deposit>> createDeposit(@RequestHeader("username") final String username,
    ...
    public Mono<ResponseEntity<List<Deposit>>> findDeposits(@RequestHeader("username") final String username) {
    ...
    public Mono<ResponseEntity<Deposit>> findDeposit(@RequestHeader("username") final String username,
    ...
    public Mono<ResponseEntity<Deposit>> updateDeposit(@RequestHeader("username") final String username,
                                                       @RequestHeader("Authorization") final String authHeader,
                                                       @Valid @RequestBody final DepositDto depositDto,
                                                       @PathVariable final String depositName) {
    ...
    public Mono<ResponseEntity<Void>> deleteDeposit(@RequestHeader("username") final String username,
                                                    @RequestHeader("Authorization") final String authHeader,
                                                    @PathVariable final String depositName) {
