...
import static pl.com.seremak.simplebills.commons.utils.ValidationUtils.validateUsername;
...
public class TransactionEventEndpoint {
    ...
    public Mono<ResponseEntity<Balance>> postTransaction(@RequestHeader("username") final String username,
                                                         @Valid @RequestBody final TransactionEventDto transactionEventDto) {
        validateUsername(username, transactionEventDto.getUsername());
